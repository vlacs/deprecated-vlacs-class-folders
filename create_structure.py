...
def main():
	Database.execute("CREATE TABLE IF NOT EXISTS vlacs_class_folders_structure(id serial, folder_name character(255), folder_id character(255), folder_parent character(255));")
